### ------ Update December 2019 by YuCong, MingYuxin, WuShushu ------


## new files
* [Final_dataset/](Final_dataset) contains code to train modified model using final dataset, as well as our model.
* [create_dataset/](create_dataset) contains all the code to create a new dataset, as well as raw data in the form of txt and dataset after preprocessing. 
* [mini-train/](scripts) contains code to train on a mini-dataset. Including two parts: training using original model and modified model.
